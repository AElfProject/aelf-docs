...
1. **[Executor/Verifier](/resources/whitepaper-2/modular-blockchain/#zkevm--zkprover):** zkEVM / ZKProver
2. **[Data Availability](/resources/whitepaper-2/modular-blockchain/#data-availability):** External DA + Data Availability Committee (DAC)
3. **[Consensus](/resources/whitepaper-2/modular-blockchain/#consensus-contract):** On-chain Smart Contracts
4. **[Sequencer](/resources/whitepaper-2/modular-blockchain/#sequencer)**
5. **[Bridge](/resources/whitepaper-2/modular-blockchain/#bridge)**
...
3. **Trustworthy Finality**: Once the Sequencer adds a transaction to the state, it shares this information with other nodes, making the transaction final. Other nodes need to trust that the transaction has been added to the state until they receive data availability (DA) and validity (ZKP) confirmations, as detailed below in **[Transaction Journey on aelf ZK-Rollup](/resources/whitepaper-2/modular-blockchain/#transaction-journey-on-aelf-zk-rollup).**
