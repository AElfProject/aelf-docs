---
sidebar_position: 10
title: NFT AeFinder dApp
description: Very complex dApp 
---

**Description**: This tutorial provides a comprehensive guide to building an NFT dApp using aelf's multi-token contract. It covers the entire process from creating NFT collections to generating non-fungible tokens and enabling seamless transfers between token holders on the aelf blockchain. It also integrates the AeFinder (the indexer) with the dApp.
...
## Step 3 - Setup the Indexer, AeFinder

### Create AeIndexer in AeFinder
- Log in to the AeFinder website.
TestNet: https://test.aefinder.io/login
- Enter the AeIndexer Name and other information to create a Token AeIndexer.

![ae-finder](/img/aefinder-1.png)

![ae-finder](/img/aefinder-2.png)

### Develop Token AeIndexer
...
![ae-finder](/img/aefinder-3.png)

- After unzipping, you can start developing.

#### Develop AeIndexer
- Obtain the Token contract files through the AeFinder github Token AeIndexer samples, and copy these two files to the directory src/TokenAeIndexer/Contracts.

:::tip
Note: If other contract files are needed, they need to be generated by compiling the corresponding contract project.
:::
...
-  Add entities
Add Account.cs, AccountNFT.cs and TransferRecord.cs files to the directory src/TokenAeIndexer/Entities.
...
1. TokenTransferredProcessor.cs
...
- Add query
  - Add files AccountDto.cs, AccountNFTDto.cs, TransferRecordDto.cs, GetAccountInput.cs, GetTransferRecordInput.cs to the directory src/TokenAeIndexer/GraphQL.
...
- DLL file location: src/TokenAeIndexer/bin/Release/net8.0/TokenAeIndexer.dll

![ae-finder](/img/aefinder-5.png)
...
:::tip
Note: For the complete demo code, please visit AeFinder github to download. https://github.com/AeFinderProject/aefinder/tree/master/samples/TokenAeIndexer
:::


## Step 4 - Interact with aelf's multi-token contract
